...
"[project]/lib/data-store.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (storedUser) {
            ...
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["users"].find((u)=>u.email === parsedUser.email);
            if (currentUser) {
                setUser(currentUser);
    ...
    const login = async (email, password)=>{
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["users"].find((u)=>u.email === email && u.password === password);
        if (foundUser) {
            setUser(foundUser);
    ...
    const checkPermission = (category, permission)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasPermission"])(user, category, permission);
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d15fddf._.js.map
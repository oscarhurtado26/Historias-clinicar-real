...
function PacientesPage() {
    ...
    const filteredPatients = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["patients"].filter((patient)=>patient.name.toLowerCase().includes(searchTerm.toLowerCase()) || patient.email.toLowerCase().includes(searchTerm.toLowerCase()) || patient.id.toLowerCase().includes(searchTerm.toLowerCase()));
...
//# sourceMappingURL=_ab38c728._.js.map
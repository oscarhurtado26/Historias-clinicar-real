...
"[project]/lib/data-store.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const treatments = [];
const consultations = [];
function generateAlertForPatient(patientId, patientName, treatmentName) {
    const alertTypes = [
        {
            priority: "Media",
...
function generateAllergyAlerts(patient) {
...
function updateRolePermissions(roleType, newPermissions) {
    // Update the template
...
function updateClinicConfiguration(config) {
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            if (storedUser) {
                ...
                const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["users"].find({
                    "AuthProvider.useEffect.currentUser": (u)=>u.email === parsedUser.email
                }["AuthProvider.useEffect.currentUser"]);
                if (currentUser) {
                    setUser(currentUser);
    ...
    const login = async (email, password)=>{
        const foundUser = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["users"].find((u)=>u.email === email && u.password === password);
        if (foundUser) {
            setUser(foundUser);
    ...
    const checkPermission = (category, permission)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasPermission"])(user, category, permission);
    };
...
//# sourceMappingURL=_6fd26ffa._.js.map